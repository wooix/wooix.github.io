...
| [4강 · 코드와 실행 기반 검증](/notes/synthetic-data-study/04-code-verification/) | 검증 설계 | 실행으로 확인되는 것과 남는 오류는 무엇인가? | 검증 절차와 실패 분류 |
| [5강 · 추론·에이전트 데이터와 최신 흐름](/notes/synthetic-data-study/05-reasoning-agents/) | 학습 신호 확장 | 풀이와 행동 경험을 어떻게 생성·선별·전달하는가? | 학습 단계별 데이터 지도 |
| [6강 · 평가·신뢰성과 종합 설계](/notes/synthetic-data-study/06-evaluation-trust/) | 근거 판단 | 개선을 어떤 평가와 비교 조건으로 입증할 것인가? | 종합 설계서와 근거 장부 |

현재 1–6강 상세 강의가 모두 공개되어 있습니다. 누적 산출물은 생각을 구체화하기 위한 문서 과제이며, 대규모 생성이나 모델 학습 실행을 필수로 요구하지 않습니다.
...
[4강 상세 학습자료 읽기 →](/notes/synthetic-data-study/04-code-verification/)
...
[5강 상세 학습자료 읽기 →](/notes/synthetic-data-study/05-reasoning-agents/)
...
[6강 상세 학습자료 읽기 →](/notes/synthetic-data-study/06-evaluation-trust/)
